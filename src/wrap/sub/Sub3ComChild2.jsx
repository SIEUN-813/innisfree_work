    ...
    React.useEffect(()=>{
        ...
        .then((result)=>{ 
            setState({
                ...
                탭2버튼1제품1:result.data.weeklyBest1top,
                탭2버튼1제품2:result.data.weeklyBest1bottom,
                탭2버튼2제품1:result.data.weeklyBest2top,
                탭2버튼2제품2:result.data.weeklyBest2bottom,
                탭2버튼3제품1:result.data.weeklyBest3top,
                탭2버튼4제품1:result.data.weeklyBest4top,
                탭2버튼5제품1:result.data.weeklyBest5top,
                탭2버튼6제품1:result.data.weeklyBest6top,
                탭2버튼7제품1:result.data.weeklyBest7top,
            })
        })
        .catch((error)=>{
        });
