...
export default function Sub3ComChild1({btn1,btn2,btn3,btn4,btn5,btn6,btn7,path}){
    ...
    React.useEffect(()=>{
        ...
        .then((result)=>{ 
            setState({
                ...
                탭1버튼1제품1:result.data.liveBest1top,
                탭1버튼1제품2:result.data.liveBest1bottom,
                탭1버튼2제품1:result.data.liveBest2top,
                탭1버튼2제품2:result.data.liveBest2bottom,
                탭1버튼3제품1:result.data.liveBest3top,
                탭1버튼4제품1:result.data.liveBest4top,
                탭1버튼5제품1:result.data.liveBest5top,
                탭1버튼6제품1:result.data.liveBest6top,
                탭1버튼7제품1:result.data.liveBest7top,
            })
        })
        .catch((error)=>{
        });
        ...
        }
        {
            ...
            <div className="content tab1btn6">
                 <div className="non-list">
                    <img src="./images/sub/sub3/ico_nodate.png" alt="" />
                    <p>등록된 제품이 없습니다.</p>
                </div>
            <div className="event-slide">
                <div className="slide-container">
