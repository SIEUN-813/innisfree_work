...
export default function AdminUserinfoModifyCom(){
    ...
    const onSubmitForm=(e)=>{
        ...
        if(state.pw===''){
            ...
            axios({
                url:'http://sieun.co.kr/innisfree/innisfree_admin_userinfo_modify.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{               
    ...
    const onClickModalClose=(e)=>{
     ...
     const onClickDelete=(e)=>{
        ...
        axios({
            url:'http://sieun.co.kr/innisfree/innisfree_admin_userinfo_delete.php',
            method: 'POST',
            data: formData
        })
        .then((res)=>{               
            if(res.status===200){   
                if(res.data===1){                        
                    ...
                    messageModalMethod('삭제에 실패하였습니다. 확인 후 다시 시도해주세요.');
                }
            ...
            <div className="content">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <input type="text" id='userAddress' name='userAddress' value={state.address} onChange={onChangeAddress} disabled/>
